...
import 'package:lottery_app/home/widgets/FeaturedPredictionCard_widgetssecond.dart.dart';
        ...
        children: [
          ...
          Consumer<PlanController>(
            builder: (context, controller, _) {
              // Show Featured Prediction Card if needed
              if (controller.showFeatured) {
                return FeaturedPredictionCard(
                  predictionData: featuredPrediction,
                );
              }
              // Show Futures Card if prediction data is available
              else if (controller.showFuturesCard &&
                  controller.futuresData != null) {
                return FuturesCardWidget(
                  predictionData: controller.futuresData!,
                );
              }
